...
const SingleProduct = () => {
    ...
    const handleTabView = (viewName: string) => setTabView(viewName);

    //   get product
    let product = response.filter((product) => product.id == numericId)[0];
    ...
    return (
        <div>
            ...
            <div className="flex text-gray-800 dark:text-gray-300">
                ...
                {">"}
                <NavLink to="/app/all-products" className="mx-2 text-purple-600">
                    All Products
                </NavLink>
                {">"}
            ...
            <Card className="my-8 shadow-md">
                <CardContent>
                    ...
                    <div className="flex items-center">
                        ...
                        <Button variant="link" onClick={() => handleTabView("description")}>
                            Description
                        </Button>
                        <Button variant="link" onClick={() => handleTabView("faq")}>
                            FAQ
                        </Button>
                    </div>
                    ...
                    <div className="mx-3 mt-4">
                      ...
                      /> */}
                                            <Avatar className="hidden mr-3 md:block">
                                                <AvatarImage src={review.avatar_url} alt="avatar" />
